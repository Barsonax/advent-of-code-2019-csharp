...
namespace AoC.Tests
{
    public class Puzzle5Tests
    {
        ...
        public void Test5()
        {
            ...
            Assert.Equal(new long[] { 11933517, 0, 0, 0, 0, 0, 0, 0, 0, 0 }, memory.Output);
        }

        [Fact]
        public void EqualTo_PositionMode_False()
        {
            var memory = new Memory(new[] { 3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8 });
            memory.AddInputs(7);
            ...
            Assert.Equal(0, memory.Output.Peek());
        }
        ...
        public void EqualTo_PositionMode_True()
        {
            ...
            Assert.Equal(1, memory.Output.Peek());
        }

        [Fact]
        public void EqualTo_ImmediateMode_False()
        {
            var memory = new Memory(new[] { 3, 3, 1108, -1, 8, 3, 4, 3, 99 });
            memory.AddInputs(7);
        ...
        {
            var memory = new Memory(new[] { 3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8 });
            memory.AddInputs(8);
        ...
        {
            var memory = new Memory(new[] { 3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9 });
            var computer = new ProgramRunner(memory);
        ...
        {
            var memory = new Memory(new[] { 3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1 });
            var computer = new ProgramRunner(memory);
